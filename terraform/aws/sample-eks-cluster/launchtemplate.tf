...
//   description            = "EKS Cluster Node group Auto-Scaling Launch Template"
...
//     ebs {
//       volume_size           = var.gp_node_group_disk_size
//       volume_type           = "gp2"
//       delete_on_termination = true
//       encrypted             = true

//       # Enable this if you want to encrypt your node root volumes with a KMS/CMK. encryption of PVCs is handled via k8s StorageClass
...
//       kms_key_id            = data.aws_kms_key.sample_kms_key.arn
//     }
//   }

//   // instance_type = var.gp_node_group_instance_type
